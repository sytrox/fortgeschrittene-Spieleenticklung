...
public class ShipControler extends AbstractControl {
    ...
    protected void controlUpdate(float tpf) {
        if (firstrun) {
            this.spatial.lookAt(new Vector3f(0, -10000, 0), Vector3f.UNIT_Z);
            firstrun = false;
        }
    ...
    public void setNewPosition(Vector3f newPosition) {
        ...
        double buff = calcRotationAngleInDegrees(oldPosition, newPosition);
     ...
     */
    public static double calcRotationAngleInDegrees(Vector3f centerPt, Vector3f targetPt) {
